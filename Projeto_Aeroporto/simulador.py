...
def simula(mc1, mc2, ma, me, md, x, y, ts):
    ...
    def simula_evento(evt):
        ...
        if evt.cat() == 'chega':
            ...
            if pista == 'livre': 
                e = evento(ic + obsexp(ma), 'fest', 'nao_prioritario')
                c.acr(e)
                pista = 'ocupada'
            else:
